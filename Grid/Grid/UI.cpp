...
void UI::Initialize()
{
  ...
  gridInfoText.setFillColor(sf::Color::Magenta);
...
void UI::Update(WorldGrid& worldGrid, TileSelector tileSelector)
{
  ...
  ss //<< "Screen: " << mousePosScreen.x << ", " << mousePosScreen.y << std::endl
    << "Window: " << worldGrid.mousePosWindow.x << ", " << worldGrid.mousePosWindow.y << std::endl
